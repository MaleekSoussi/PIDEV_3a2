...
public class LoginController{
    ...
    public void login(ActionEvent event) {
        ...
        if (us.login(email, password)) { // Use UserService's login method for authentication
            Users user = us.getCurrentUser(); // Get the logged-in user
            System.out.println("Logged in user: " + us.getCurrentUser());
            ...
            try {
                ...
                System.out.println("Logged in user before scene change: " + us.getCurrentUser());
