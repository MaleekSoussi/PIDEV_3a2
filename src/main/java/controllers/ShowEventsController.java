...
public class ShowEventsController {
    ...
    @FXML
    private TableView<models.Event> Eventtable;
    ...
    */
    ...
    void listTickets(ActionEvent event) throws IOException {
        ...
        if (selectedEvent != null) {
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/showTickets.fxml"));
    ...
    void print(ActionEvent event) throws SQLException
    {
        ...
        if (selectedFile != null)
        {
            try
            {
                ...
                // Add logo
                String imagePath = "C:\\xampp\\htdocs\\images\\logo.png";
                ...
                String signaturePath = "C:\\xampp\\htdocs\\images\\signature.png";
                com.itextpdf.text.Image image1 = com.itextpdf.text.Image.getInstance(signaturePath);
                image1.setAbsolutePosition(500, document.getPageSize().getHeight() - 720);
                image1.scaleToFit(70, 70);
                document.add(image1);

                String handsignaturePath = "C:\\xampp\\htdocs\\images\\handsignature.png";
                com.itextpdf.text.Image image2 = com.itextpdf.text.Image.getInstance(handsignaturePath);
