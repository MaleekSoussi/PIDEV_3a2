...
public class EventItemController {
    ...
    private controllers.ShowEventsFController showEventsFController;
    public static int i;
    ...
    public void setData(Event event)
    {
        ...
        showlistbutton.setOnAction(eventt -> {
            ...
            {
                idE=event.getIdE();
                Parent root = FXMLLoader.load(getClass().getResource("/ShowTicketsF.fxml"));
        ...
        editeventbuttonF.setOnAction(eventt -> {
            ...
            {
                i = event.getIdE();
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/UpdateEventF.fxml"));
